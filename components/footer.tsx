  ...
  return (
    <footer className="bg-gray-700">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            ...
            <p className="text-gray-400">
              ...
              porro ipsa necessitatibus aut tempore explicabo unde quis neque
              consequuntur nihil.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <form action="" className="mt-5">
              ...
              <button className="bg-blue-400 p-3 font-bold text-white w-full text-center rounded-sm hover:bg-blue-500">
                Subscribe
              </button>
            </form>
          </div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | Afrizal | All Rights Reserved
      </div>
    </footer>
  );
};
