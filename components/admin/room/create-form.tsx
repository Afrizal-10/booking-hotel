      ...
      <div className="grid md:grid-cols-12 gap-5">
          ...
          <div className="mb-4 grid md:grid-cols-3">
            {amenities.map((item) => (
              <div className="flex items-center mb-4" key={item.id}>
                ...
                />
                <label className="ms-2 text-sm capitalize font-medium text-gray-900">
                  {item.name}
                </label>
              </div>
            ))}
        ...
        <div className="col-span-4 bg-white p-4">
          ...
          >
              ...
              {image ? (
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  {message ? (
                    ...
                    <p className="text-xs">
                      SVG, PNG, JPG or GIF, or Others (Max: 8mb)
                    </p>
                  )}
                </div>
              )}
            ...
            {!image ? (
              ...
              <Image
                ...
                width={640}
                height={360}
                className="rounded-sm absolute aspect-video object-cover"
              />
            )}
          </label>
          ...
          <button
            type="submit"
            className={clsx(
              "bg-blue-400 text-white w-full hover:bg-blue-500 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer rounded-sm",
              {
